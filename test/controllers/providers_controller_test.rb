...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference('Provider.count') do
      post providers_url, params: { provider: { SPID: @provider.SPID, name: @provider.name, sensitivity: @provider.sensitivity } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { SPID: @provider.SPID, name: @provider.name, sensitivity: @provider.sensitivity } }
